...
function AddIncomeSource(props) {
    return (
        <Svg
            width={25}
            height={24}
        ...
        >
            <Path
                d="M14.762 15.438h-5M12.262 12.998v5"
                stroke="#1D1D1F"
                strokeWidth={1.5}
                strokeMiterlimit={10}
                strokeLinecap="round"
            ...
            />
            <Path
                d="M13.16 2.518l-.03.07-2.9 6.73H7.38c-.68 0-1.33.14-1.92.39l1.75-4.18.04-.1.07-.16c.02-.06.04-.12.07-.17 1.31-3.03 2.79-3.72 5.77-2.58z"
                stroke="#1D1D1F"
                strokeWidth={1.5}
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            />
            <Path
                d="M7.21 5.528l-1.75 4.18a4.894 4.894 0 00-2.96 4.49v-2.93c0-2.84 2.02-5.21 4.71-5.74zM22.019 11.268v2.93c0-2.2-1.46-4.07-3.46-4.67.52-1.3.67-2.32.42-3.17-.02-.09-.05-.18-.09-.26 1.86.96 3.13 2.93 3.13 5.17z"
                stroke="#1D1D1F"
                strokeWidth={1.5}
                strokeLinecap="round"
                strokeLinejoin="round"
